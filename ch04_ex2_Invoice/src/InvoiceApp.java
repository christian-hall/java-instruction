...
public class InvoiceApp {
	...
	public static void main(String[] args) {
		...
		while (!choice.equalsIgnoreCase("n")) {
			 ...
			 * discountPercent = .25; } else if (subtotal >= 500) { discountPercent = .3; }
			 * break; case "c": case "C": discountPercent = .2; break; case "t": case "T":
			 * if (subtotal < 500) { discountPercent = 0.4; } else if (subtotal >= 500) {
			 * discountPercent = 0.5; } break; default: discountPercent = .0; break; }
			 */
